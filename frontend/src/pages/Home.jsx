    ...
    <main className="space-y-0">
        ...
        <div className="max-w-5xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          <div className="md:col-span-2 space-y-3">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              HAI Lab은 <strong>Manufacturing AI</strong>, <strong>Physics-Informed ML</strong>, <strong>Fault Diagnosis</strong>, <strong>Digital Twin</strong>, <strong>Physical AI</strong>, <strong>Foundation Models</strong>를 중심으로 자율 지능 시스템을 연구합니다. HotPaper.ai는 매일 수백 편 중에서 진짜 임팩트 있는 25편만 골라 핵심 그림·결과 표와 함께 한국어로 요약합니다.
            </p>
      ...
      <section className="bg-blue-50/40 dark:bg-blue-950/10">
        <FeaturedSection
          endpoint="/hai/papers"
          title="🎓 HAI Lab Picks"
          subtitle="Manufacturing AI · Physics-Informed ML · Fault Diagnosis · Digital Twin · Physical AI · Foundation Models — HAI Lab 자체 발표 및 관련 분야 논문"
          accent="indigo"
          count={6}
          badge="HAI"
          viewAllPath="/hai"
