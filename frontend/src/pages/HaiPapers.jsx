      ...
      <section className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-6xl mx-auto px-4 py-10">
          ...
          <p className="text-base text-gray-600 dark:text-gray-300 max-w-3xl leading-relaxed">
            HAI Lab은 <strong>Manufacturing AI</strong>, <strong>Physics-Informed ML</strong>, <strong>Fault Diagnosis</strong>, <strong>Digital Twin</strong>, <strong>Foundation Models</strong>를 중심으로 자율 지능 시스템을 연구합니다.
            <br />
